...
from utils.supertokens.session import PydanticSessionContainer
from utils.supertokens.verify import verify_session
...
async def edit_event(
    ...
    session: Annotated[PydanticSessionContainer, Depends(verify_session)],
) -> EventsWithID:
